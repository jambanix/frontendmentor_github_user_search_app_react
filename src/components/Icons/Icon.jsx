...
export const Icon = ({containerClassName=null, iconType="search", available=true, fill="#4b6a9b", isHovering=false}) => {

    !available ? containerClassName = `${containerClassName} opacity-50` : containerClassName
    ...
    switch (iconType) {
        ...
        case "location":
            return (<LocationIcon fill={fill} containerClassName={containerClassName}/>);
        case "website":
            return (<WebsiteIcon fill={fill} containerClassName={containerClassName}/>);
        case "twitter":
            return (<TwitterIcon fill={fill} containerClassName={containerClassName}/>);
        case "work":
